...
\researchentry{Jun 2026--Present}{DLEF: Explaining Why ECG Models Fail Across Hospitals}{First author; submitted to \textbf{IEEE BIBM 2026}}{\begin{itemize}
  ...
  \item \textbf{Contribution:} Formulated the question and conducted study design, implementation, experiments, analysis, and writing; developed directional dataset-label ``evidence fingerprints.''
...
\researchentry{Jun 2026--Present}{Matched-Control Perturbation Auditing: Does an ECG Model Use Clinical Evidence?}{First author; revision in progress at \textbf{IEEE JBHI}}{\begin{itemize}
