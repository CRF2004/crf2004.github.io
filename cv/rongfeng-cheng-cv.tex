...
\cvitem{IP}{First inventor on one patent application that passed preliminary examination and another submitted patent application; awarded two software copyrights.}
