...
- Mathematical modeling: Second Prize, 2025 9th Guangzhou Mathematical Modeling University League (Fruit_CNN repository); Third Prize, 2025 China Undergraduate Mathematical Contest in Modeling, Guangdong Division (missile-problem paper). Rongfeng was responsible for mathematical modeling and algorithm implementation in both competitions. The national-contest solution used nonlinear programming, genetic algorithms, and particle swarm optimization for smoke-screen deployment timing and spatial-coverage optimization. The repositories are private but accessible through the connected GitHub app.

Open questions:

- Official titles, personal rank, and dates for the 2025/2026 national innovation projects and the two 2025 campus competition recognitions.
